    ...
    <div style={{ background: '#1C1B2E', color: '#F3F0FB', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <nav style={{ background: '#2D1B5E', padding: '20px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 2px 10px rgba(191, 5, 125, 0.15)' }}>
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          ...
          <button onClick={() => router.push('/dashboard')} style={{ background: '#BF057D', color: '#FFF', border: 'none', padding: '10px 24px', borderRadius: '8px', cursor: 'pointer', fontSize: '14px', fontWeight: '700' }}>Descubre tu valor</button>
        </div>
      </nav>
      ...
      <section style={{ padding: '80px 40px', textAlign: 'center', background: 'linear-gradient(135deg, #2D1B5E 0%, #1C1B2E 100%)' }}>
        ...
        <button onClick={() => router.push('/dashboard')} style={{ background: '#BF057D', color: '#FFF', border: 'none', padding: '16px 48px', borderRadius: '8px', cursor: 'pointer', fontSize: '16px', fontWeight: '700', boxShadow: '0 8px 20px rgba(191, 5, 125, 0.3)' }}>
          Comenzar análisis
        </button>
      </section>
      ...
      {/* CTA FINAL */}
      <section style={{ padding: '80px 40px', textAlign: 'center', background: 'linear-gradient(135deg, #BF057D 0%, #2D1B5E 100%)' }}>
        <h2 style={{ fontSize: '44px', fontWeight: '800', marginBottom: '20px', color: '#FFF' }}>
          ¿Listo para descubrir tu valor?
        </h2>
        <p style={{ fontSize: '18px', color: '#F3F0FB', marginBottom: '40px' }}>
          Toma el control de tu carrera. Análisis completo en 5 minutos.
        </p>
        <button onClick={() => router.push('/dashboard')} style={{ background: '#FFF', color: '#BF057D', border: 'none', padding: '16px 48px', borderRadius: '8px', cursor: 'pointer', fontSize: '16px', fontWeight: '700', boxShadow: '0 8px 20px rgba(0, 0, 0, 0.2)' }}>
          Comenzar ahora
        </button>
      </section>
      ...
      <footer style={{ background: '#0F0E1A', padding: '40px', textAlign: 'center', borderTop: '1px solid rgba(191, 5, 125, 0.2)' }}>
        ...
        <p style={{ fontSize: '12px', color: '#E8E4F4', marginBottom: '12px' }}>
