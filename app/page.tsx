  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
        <Link href="/register" style={{ padding: '14px 28px', background: 'linear-gradient(135deg, #22c55e 0%, #16a34a 100%)', color: '#0f172a', borderRadius: 12, fontSize: 15, fontWeight: 800, textDecoration: 'none', boxShadow: '0 4px 20px rgba(34,197,94,0.25)' }}>Empezar ahora</Link>
        <Link href="/login" style={{ padding: '14px 28px', background: 'rgba(30,41,59,0.6)', color: '#f8fafc', borderRadius: 12, fontSize: 15, fontWeight: 700, textDecoration: 'none', border: '1px solid rgba(148,163,184,0.2)' }}>Iniciar sesión</Link>
      </div>
    </main>
  )
}
